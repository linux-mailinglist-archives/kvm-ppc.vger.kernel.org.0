...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 4A46327927A
	for <lists+kvm-ppc@lfdr.de>; Fri, 25 Sep 2020 22:45:29 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727727AbgIYUoz (ORCPT <rfc822;lists+kvm-ppc@lfdr.de>);
        Fri, 25 Sep 2020 16:44:55 -0400
Received: from hqnvemgate26.nvidia.com ([216.228.121.65]:12613 "EHLO
        hqnvemgate26.nvidia.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727519AbgIYUoy (ORCPT
        <rfc822;kvm-ppc@vger.kernel.org>); Fri, 25 Sep 2020 16:44:54 -0400
...
Subject: [PATCH 2/2] mm: remove extra ZONE_DEVICE struct page refcount
...
@@ -240,7 +240,7 @@ static inline bool dax_mapping(struct address_space *ma=
pping)
=20
...
@@ -1092,39 +1092,6 @@ static inline bool is_zone_device_page(const struct =
page *page)
 }
 #endif
=20
...
=20
 	switch (pgmap->type) {
 	case MEMORY_DEVICE_PRIVATE:
@@ -217,11 +171,9 @@ void *memremap_pages(struct dev_pagemap *pgmap, int ni=
d)
 		}
 		break;
...
@@ -245,12 +197,6 @@ void *memremap_pages(struct dev_pagemap *pgmap, int ni=
d)
 		}
 	}
=20
