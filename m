...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id C2E087929A9
	for <lists+kvm-ppc@lfdr.de>; Tue,  5 Sep 2023 18:53:13 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S244174AbjIEQXH (ORCPT <rfc822;lists+kvm-ppc@lfdr.de>);
        Tue, 5 Sep 2023 12:23:07 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:36484 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1344580AbjIEDsu (ORCPT
        <rfc822;kvm-ppc@vger.kernel.org>); Mon, 4 Sep 2023 23:48:50 -0400
Received: from mail-pf1-x435.google.com (mail-pf1-x435.google.com [IPv6:2607:f8b0:4864:20::435])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 72820CC7;
        Mon,  4 Sep 2023 20:48:43 -0700 (PDT)
Received: by mail-pf1-x435.google.com with SMTP id d2e1a72fcca58-68a41035828so1117948b3a.1;
        Mon, 04 Sep 2023 20:48:43 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20221208; t=1693885723; x=1694490523; darn=vger.kernel.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=+C8yndawkeKqSFZ35SUwwqF+4ioTCbHEcspw6Lqbdf8=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20221208; t=1693885723; x=1694490523;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=+C8yndawkeKqSFZ35SUwwqF+4ioTCbHEcspw6Lqbdf8=;
        b=
X-Gm-Message-State: AOJu0YwkJhp1s6mBOgikHsI+kMkfu0xOH6AmTXY6okfw2i6ICDk4i/IX
        Zy9Ez+kj7LTtcZk9em7EbEQ=
X-Google-Smtp-Source: AGHT+IHQbA/2sNdrnmkWoB9va5yE7ua+peeHRRUgN1/EQ7gAin9alImW1K9w9Xx7pX+r+jE9ETuBIw==
X-Received: by 2002:a05:6a20:96d5:b0:136:ea0e:d23 with SMTP id hq21-20020a056a2096d500b00136ea0e0d23mr8445173pzc.11.1693885722523;
        Mon, 04 Sep 2023 20:48:42 -0700 (PDT)
Received: from pwon.ozlabs.ibm.com ([129.41.57.2])
        by smtp.gmail.com with ESMTPSA id v23-20020aa78097000000b0063f0068cf6csm7994951pff.198.2023.09.04.20.48.33
...
Subject: [PATCH v4 10/11] KVM: PPC: Add support for nestedv2 guests
Date:   Tue,  5 Sep 2023 13:46:57 +1000
Message-Id: <20230905034658.82835-11-jniethe5@gmail.com>
...
index 8d26f2537586..fb2ff2bff0a4 100644
...
+#include <linux/delay.h>
 ...
 #include <asm/hvcall.h>
 #include <asm/paca.h>
@@ -343,6 +344,193 @@ static inline long plpar_get_cpu_characteristics(struct h_cpu_char_result *p)
 	return rc;
 }
...
+
  ...
  *
@@ -407,6 +595,62 @@ static inline long pseries_rpt_invalidate(u64 pid, u64 target, u64 type,
 	return 0;
 }
...
index d4db8192753b..4a40d31a0212 100644
...
index 9b63fae27eba..5018d25259b0 100644
...
@@ -507,10 +530,15 @@ void kvmhv_set_ptbl_entry(u64 lpid, u64 dw0, u64 dw1)
 		return;
 	}
...
index 000000000000..c59c4e13f40c
--- /dev/null
