...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id CF7CD32EDF7
	for <lists+kvm-ppc@lfdr.de>; Fri,  5 Mar 2021 16:10:21 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230210AbhCEPJu (ORCPT <rfc822;lists+kvm-ppc@lfdr.de>);
        Fri, 5 Mar 2021 10:09:50 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:42938 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230285AbhCEPJT (ORCPT
        <rfc822;kvm-ppc@vger.kernel.org>); Fri, 5 Mar 2021 10:09:19 -0500
Received: from mail-pg1-x529.google.com (mail-pg1-x529.google.com [IPv6:2607:f8b0:4864:20::529])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 0F136C061574
        for <kvm-ppc@vger.kernel.org>; Fri,  5 Mar 2021 07:09:19 -0800 (PST)
Received: by mail-pg1-x529.google.com with SMTP id x29so1565927pgk.6
        for <kvm-ppc@vger.kernel.org>; Fri, 05 Mar 2021 07:09:19 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=GCj1eL+mpgJAE9CRT+T0aq9bUJkm7BDK1ipFdNE5ZN0=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=GCj1eL+mpgJAE9CRT+T0aq9bUJkm7BDK1ipFdNE5ZN0=;
        b=
X-Gm-Message-State: AOAM533jksKnHYXP8ReYB8tIP5MX66J67Y7ddr28oUsiIsVPF2MzoODO
        2LuItPyxQG9bTWPsDkDDrSf2QptziT4=
X-Google-Smtp-Source: ABdhPJwgWmC6bE8PahuCemJArFNHTu/6sy1MjIlJAKf1NhP68O0BAJlBhOn6Ft1wI5EUnQYyznYI3g==
X-Received: by 2002:a63:1725:: with SMTP id x37mr9134153pgl.48.1614956957307;
        Fri, 05 Mar 2021 07:09:17 -0800 (PST)
Received: from bobo.ibm.com (58-6-239-121.tpgi.com.au. [58.6.239.121])
        by smtp.gmail.com with ESMTPSA id m5sm1348982pfd.96.2021.03.05.07.09.14
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Fri, 05 Mar 2021 07:09:16 -0800 (PST)
From:   Nicholas Piggin <npiggin@gmail.com>
To:     kvm-ppc@vger.kernel.org
Cc:     Nicholas Piggin <npiggin@gmail.com>, linuxppc-dev@lists.ozlabs.org
Subject: [PATCH v3 41/41] KVM: PPC: Book3S HV: remove ISA v3.0 and v3.1 support from P7/8 path
Date:   Sat,  6 Mar 2021 01:06:38 +1000
Message-Id: <20210305150638.2675513-42-npiggin@gmail.com>
...
index db3f7e0bf832..f505d5d84d4d 100644
...
-
 ...
 /*
@@ -3070,9 +3067,6 @@ static void prepare_threads(struct kvmppc_vcore *vc)
...
@@ -3279,6 +3273,9 @@ static noinline void kvmppc_run_core(struct kvmppc_vcore *vc)
 	int trap;
 	bool is_power8;
...
@@ -3306,9 +3303,6 @@ static noinline void kvmppc_run_core(struct kvmppc_vcore *vc)
...
@@ -3332,18 +3326,6 @@ static noinline void kvmppc_run_core(struct kvmppc_vcore *vc)
...
@@ -3376,8 +3358,7 @@ static noinline void kvmppc_run_core(struct kvmppc_vcore *vc)
 	cmd_bit = stat_bit = 0;
...
+	is_power8 = cpu_has_feature(CPU_FTR_ARCH_207S);
 	...
 	if (split > 1) {
 		sip = &split_info;
@@ -3665,8 +3646,7 @@ static void restore_p9_host_os_sprs(struct kvm_vcpu *vcpu,
 }
...
+ * Guest entry for POWER9 and later CPUs.
 ...
 static int kvmhv_p9_guest_entry(struct kvm_vcpu *vcpu, u64 time_limit,
 			 unsigned long lpcr)
@@ -5679,11 +5659,25 @@ static int kvmhv_enable_dawr1(struct kvm *kvm)
...
@@ -5827,18 +5821,6 @@ static int kvmppc_book3s_init_hv(void)
