...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 1D7CF32EDDF
	for <lists+kvm-ppc@lfdr.de>; Fri,  5 Mar 2021 16:09:18 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230093AbhCEPIq (ORCPT <rfc822;lists+kvm-ppc@lfdr.de>);
        Fri, 5 Mar 2021 10:08:46 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:42722 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230109AbhCEPI2 (ORCPT
        <rfc822;kvm-ppc@vger.kernel.org>); Fri, 5 Mar 2021 10:08:28 -0500
Received: from mail-pg1-x532.google.com (mail-pg1-x532.google.com [IPv6:2607:f8b0:4864:20::532])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 00605C061574
        for <kvm-ppc@vger.kernel.org>; Fri,  5 Mar 2021 07:08:27 -0800 (PST)
Received: by mail-pg1-x532.google.com with SMTP id l2so1564251pgb.1
        for <kvm-ppc@vger.kernel.org>; Fri, 05 Mar 2021 07:08:27 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=H90GP4g3JVwJTCXV7Up0LswGru+bMZXQFwv37EDF2L0=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=H90GP4g3JVwJTCXV7Up0LswGru+bMZXQFwv37EDF2L0=;
        b=
X-Gm-Message-State: AOAM531I9qzKBgFqqKV9DfbAZ49RVt+j6fHr4p5lPGzFAF+QwWoeNyzG
        wsRcz1BKJ1Ax53Sz/PaI7g7GWns+GqI=
X-Google-Smtp-Source: ABdhPJyMJGFr4EPZVtyUW3FOzf2liKgx5pZhCIz9CT7Oui2iNdRyE6l7TRlm8eYixB3mtL2vyl0cIg==
X-Received: by 2002:a62:2786:0:b029:1ee:afe7:6bfb with SMTP id n128-20020a6227860000b02901eeafe76bfbmr9041733pfn.14.1614956906579;
        Fri, 05 Mar 2021 07:08:26 -0800 (PST)
Received: from bobo.ibm.com (58-6-239-121.tpgi.com.au. [58.6.239.121])
        by smtp.gmail.com with ESMTPSA id m5sm1348982pfd.96.2021.03.05.07.08.21
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Fri, 05 Mar 2021 07:08:25 -0800 (PST)
From:   Nicholas Piggin <npiggin@gmail.com>
To:     kvm-ppc@vger.kernel.org
Cc:     Nicholas Piggin <npiggin@gmail.com>, linuxppc-dev@lists.ozlabs.org
Subject: [PATCH v3 26/41] KVM: PPC: Book3S HV P9: Implement the rest of the P9 path in C
Date:   Sat,  6 Mar 2021 01:06:23 +1000
Message-Id: <20210305150638.2675513-27-npiggin@gmail.com>
...
index 129d3f81800e..8cb1322cfe00 100644
...
+	lbz	r11,HSTATE_IN_GUEST(r13)
 	...
 	cmpdi	r10,0x200
 	bgt+	1f
@@ -115,3 +130,233 @@ END_FTR_SECTION_IFSET(CPU_FTR_HAS_PPR)
 	GET_SCRATCH0(r13)
 	HRFI_TO_KERNEL
 #endif
+
...
index b7a88960ac49..c822fe7123fe 100644
--- a/arch/powerpc/kvm/book3s_hv.c
+++ b/arch/powerpc/kvm/book3s_hv.c
@@ -1430,6 +1430,8 @@ static int kvmppc_handle_exit_hv(struct kvm_vcpu *vcpu,
 	 */
...
@@ -3785,9 +3787,10 @@ static int kvmhv_p9_guest_entry(struct kvm_vcpu *vcpu, u64 time_limit,
 			}
 		}
