...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id A856C353AA7
	for <lists+kvm-ppc@lfdr.de>; Mon,  5 Apr 2021 03:21:53 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231855AbhDEBV4 (ORCPT <rfc822;lists+kvm-ppc@lfdr.de>);
        Sun, 4 Apr 2021 21:21:56 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:40058 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231851AbhDEBVy (ORCPT
        <rfc822;kvm-ppc@vger.kernel.org>); Sun, 4 Apr 2021 21:21:54 -0400
Received: from mail-pj1-x1036.google.com (mail-pj1-x1036.google.com [IPv6:2607:f8b0:4864:20::1036])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 30D17C061756
        for <kvm-ppc@vger.kernel.org>; Sun,  4 Apr 2021 18:21:47 -0700 (PDT)
Received: by mail-pj1-x1036.google.com with SMTP id t24so1193591pjw.4
        for <kvm-ppc@vger.kernel.org>; Sun, 04 Apr 2021 18:21:47 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=OOS3vg69VMrSnHGJdUyrzz96D+4D9TIEWp0GTQUCqFY=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=OOS3vg69VMrSnHGJdUyrzz96D+4D9TIEWp0GTQUCqFY=;
        b=
X-Gm-Message-State: AOAM532Fn2vFOPf23UjF48XxTRsvQ/CprGylkCVip/1SkJ0RkWo+ARUj
        +8iElUDSNGqTXHoZegDuvcl8HfFonWO41g==
X-Google-Smtp-Source: ABdhPJxVLH6tmCi9Z34N5grtwFuPzaM0zSZ7BB49MKjEP1uW4EE/EqpqFIbVVSJ3WsM6vHX/QLzwsQ==
X-Received: by 2002:a17:902:6a87:b029:e6:6a3d:29e8 with SMTP id n7-20020a1709026a87b02900e66a3d29e8mr21269387plk.10.1617585706172;
        Sun, 04 Apr 2021 18:21:46 -0700 (PDT)
Received: from bobo.ibm.com ([1.132.215.134])
        by smtp.gmail.com with ESMTPSA id e3sm14062536pfm.43.2021.04.04.18.21.43
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Sun, 04 Apr 2021 18:21:45 -0700 (PDT)
From:   Nicholas Piggin <npiggin@gmail.com>
To:     kvm-ppc@vger.kernel.org
Cc:     Nicholas Piggin <npiggin@gmail.com>, linuxppc-dev@lists.ozlabs.org
Subject: [PATCH v6 30/48] KVM: PPC: Book3S HV P9: Implement the rest of the P9 path in C
Date:   Mon,  5 Apr 2021 11:19:30 +1000
Message-Id: <20210405011948.675354-31-npiggin@gmail.com>
...
index 353a0c8b79fa..9a1476daca8c 100644
--- a/arch/powerpc/kvm/book3s_hv.c
+++ b/arch/powerpc/kvm/book3s_hv.c
@@ -1442,6 +1442,8 @@ static int kvmppc_handle_exit_hv(struct kvm_vcpu *vcpu,
 	 */
...
@@ -3707,6 +3709,8 @@ static int kvmhv_p9_guest_entry(struct kvm_vcpu *vcpu, u64 time_limit,
 	u64 tb, next_timer;
 	int trap, save_pmu;
...
+
 	...
 	if (tb >= next_timer)
@@ -3714,8 +3718,6 @@ static int kvmhv_p9_guest_entry(struct kvm_vcpu *vcpu, u64 time_limit,
...
@@ -3842,9 +3844,10 @@ static int kvmhv_p9_guest_entry(struct kvm_vcpu *vcpu, u64 time_limit,
 			}
 		}
...
index 000000000000..3c507daed064
--- /dev/null
