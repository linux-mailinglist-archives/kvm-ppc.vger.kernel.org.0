...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 8E75D34549F
	for <lists+kvm-ppc@lfdr.de>; Tue, 23 Mar 2021 02:06:24 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231551AbhCWBFy (ORCPT <rfc822;lists+kvm-ppc@lfdr.de>);
        Mon, 22 Mar 2021 21:05:54 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:45262 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231534AbhCWBFb (ORCPT
        <rfc822;kvm-ppc@vger.kernel.org>); Mon, 22 Mar 2021 21:05:31 -0400
Received: from mail-pj1-x102d.google.com (mail-pj1-x102d.google.com [IPv6:2607:f8b0:4864:20::102d])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 75B09C061762
        for <kvm-ppc@vger.kernel.org>; Mon, 22 Mar 2021 18:05:31 -0700 (PDT)
Received: by mail-pj1-x102d.google.com with SMTP id lr1-20020a17090b4b81b02900ea0a3f38c1so365460pjb.0
        for <kvm-ppc@vger.kernel.org>; Mon, 22 Mar 2021 18:05:31 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=OSkT5YIhfKMtabfpqa0XDziCeRWrtWMKaf7/n1rHrjU=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=OSkT5YIhfKMtabfpqa0XDziCeRWrtWMKaf7/n1rHrjU=;
        b=
X-Gm-Message-State: AOAM533BPusOYRYQ82vw6ZOy4wt6lrTlLf/PqaXCto0pHJYNP09th43t
        e4/mBs9DAfZlZFldG4il6O3AYgn8zNM=
X-Google-Smtp-Source: ABdhPJxMVzzs5H/aQu45R0pZovlPx6Smjgv1/g8svMxVQwmUwBsQg01Oddxbcxpd4rX+M63Uvdz4dg==
X-Received: by 2002:a17:90a:e7cc:: with SMTP id kb12mr1728148pjb.31.1616461529753;
        Mon, 22 Mar 2021 18:05:29 -0700 (PDT)
Received: from bobo.ibm.com ([58.84.78.96])
        by smtp.gmail.com with ESMTPSA id e7sm14491894pfc.88.2021.03.22.18.05.27
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 22 Mar 2021 18:05:29 -0700 (PDT)
From:   Nicholas Piggin <npiggin@gmail.com>
To:     kvm-ppc@vger.kernel.org
Cc:     Nicholas Piggin <npiggin@gmail.com>, linuxppc-dev@lists.ozlabs.org
Subject: [PATCH v4 46/46] KVM: PPC: Book3S HV: remove ISA v3.0 and v3.1 support from P7/8 path
Date:   Tue, 23 Mar 2021 11:03:05 +1000
Message-Id: <20210323010305.1045293-47-npiggin@gmail.com>
...
index e732d65772b1..ad6a2501ab0f 100644
...
-
 ...
 /*
@@ -3090,9 +3087,6 @@ static void prepare_threads(struct kvmppc_vcore *vc)
...
@@ -3299,6 +3293,9 @@ static noinline void kvmppc_run_core(struct kvmppc_vcore *vc)
 	int trap;
 	bool is_power8;
...
@@ -3326,9 +3323,6 @@ static noinline void kvmppc_run_core(struct kvmppc_vcore *vc)
...
@@ -3352,18 +3346,6 @@ static noinline void kvmppc_run_core(struct kvmppc_vcore *vc)
...
@@ -3396,8 +3378,7 @@ static noinline void kvmppc_run_core(struct kvmppc_vcore *vc)
 	cmd_bit = stat_bit = 0;
...
+	is_power8 = cpu_has_feature(CPU_FTR_ARCH_207S);
 	...
 	if (split > 1) {
 		sip = &split_info;
@@ -3691,8 +3672,7 @@ static inline bool hcall_is_xics(unsigned long req)
 }
...
+ * Guest entry for POWER9 and later CPUs.
 ...
 static int kvmhv_p9_guest_entry(struct kvm_vcpu *vcpu, u64 time_limit,
 			 unsigned long lpcr)
@@ -5706,11 +5686,25 @@ static int kvmhv_enable_dawr1(struct kvm *kvm)
...
@@ -5854,18 +5848,6 @@ static int kvmppc_book3s_init_hv(void)
...
index 5cbc26ebcf8e..b2a71a1b48fe 100644
